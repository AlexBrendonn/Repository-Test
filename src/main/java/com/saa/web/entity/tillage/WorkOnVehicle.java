...
@Entity(name = "WorkOnVehicle")
@Table(name = "work_on_vehicle", schema = "tillage")
public class WorkOnVehicle {
    ...
    public static WorkOnVehicle fromJSON(JSONObject json) {
        WorkOnVehicle response = new WorkOnVehicle();
