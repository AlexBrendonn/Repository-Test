...
@Entity(name = "ApplianceFieldType")
@Table(name = "appliance_field_type", schema = "tillage")
public class ApplianceFieldType {
    @Id
    ...
    public static ApplianceFieldType fromJSON(JSONObject json) {
        ApplianceFieldType response = new ApplianceFieldType();
