...
import com.saa.web.control.manager.DocumentItemControl;
...
@Path("/manager/document_item")
public class DocumentItemRouter {
    @Context
    HttpServletRequest webRequest;
    DocumentItemControl control;

    @GET
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response GET() {
        this.control = new DocumentItemControl((AuthenticationToken) webRequest.getSession().getAttribute("authentication"));
        return control.list();
    }
