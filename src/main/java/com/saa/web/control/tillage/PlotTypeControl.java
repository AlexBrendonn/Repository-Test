...
import com.saa.web.dao.tillage.PlotTypeDao;
...
public class PlotTypeControl extends MainControl {

    public PlotTypeControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            PlotTypeDao dao = new PlotTypeDao();

            PlotType object = PlotType.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<PlotType> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (PlotType object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            PlotType object = dao.get(id, this.organization);
