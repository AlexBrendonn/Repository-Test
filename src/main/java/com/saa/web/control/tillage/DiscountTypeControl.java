...
import com.saa.web.dao.tillage.DiscountTypeDao;
...
public class DiscountTypeControl extends MainControl {

    public DiscountTypeControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            DiscountTypeDao dao = new DiscountTypeDao();

            DiscountType object = DiscountType.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<DiscountType> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (DiscountType object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            DiscountType object = dao.get(id, this.organization);
