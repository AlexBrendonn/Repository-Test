...
import com.saa.web.dao.tillage.ExchangeConfigurationDao;
...
public class ExchangeConfigurationControl extends MainControl {

    public ExchangeConfigurationControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            ExchangeConfigurationDao dao = new ExchangeConfigurationDao();

            ExchangeConfiguration object = ExchangeConfiguration.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<ExchangeConfiguration> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (ExchangeConfiguration object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            ExchangeConfiguration object = dao.get(id, this.organization);
