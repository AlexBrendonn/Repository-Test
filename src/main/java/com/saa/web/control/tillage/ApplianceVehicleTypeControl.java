...
import com.saa.web.dao.tillage.ApplianceVehicleTypeDao;
...
public class ApplianceVehicleTypeControl extends MainControl {

    public ApplianceVehicleTypeControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            ApplianceVehicleTypeDao dao = new ApplianceVehicleTypeDao();

            ApplianceVehicleType object = ApplianceVehicleType.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<ApplianceVehicleType> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (ApplianceVehicleType object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            ApplianceVehicleType object = dao.get(id, this.organization);
