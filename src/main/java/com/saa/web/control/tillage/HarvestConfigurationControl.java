...
import com.saa.web.dao.tillage.HarvestConfigurationDao;
...
public class HarvestConfigurationControl extends MainControl {

    public HarvestConfigurationControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            HarvestConfigurationDao dao = new HarvestConfigurationDao();

            HarvestConfiguration object = HarvestConfiguration.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<HarvestConfiguration> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (HarvestConfiguration object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            HarvestConfiguration object = dao.get(id, this.organization);
