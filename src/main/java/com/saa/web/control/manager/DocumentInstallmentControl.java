...
import com.saa.web.dao.manager.DocumentInstallmentDao;
...
public class DocumentInstallmentControl extends MainControl {

    public DocumentInstallmentControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            DocumentInstallmentDao dao = new DocumentInstallmentDao();

            DocumentInstallment object = DocumentInstallment.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<DocumentInstallment> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (DocumentInstallment object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            DocumentInstallment object = dao.get(id, this.organization);
