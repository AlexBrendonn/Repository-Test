...
import com.saa.web.dao.register.ProductGroupDao;
...
public class ProductGroupControl extends MainControl {

    public ProductGroupControl(AuthenticationToken token) {
        super(token);
    }
    ...
    public Response save(JSONObject body){
        ...
        try {
            ...
            ProductGroup object = ProductGroup.fromJSON(body);
    ...
    public Response list() {
        ...
        try {
            ...
            List<ProductGroup> list = dao.list(this.organization);
            JSONArray array = new JSONArray();

            for (ProductGroup object : list) {
    ...
    public Response delete(Long id) {
        ...
        try {
            ...
            ProductGroup object = dao.get(id, this.organization);
